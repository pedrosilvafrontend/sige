...
export class MenuService {
  private menu$: BehaviorSubject<Menu[]> = new BehaviorSubject<Menu[]>(menu as Menu[]);
  ...
  private isRouteEqual(routeArr: string[], realRouteArr: string[]): boolean {
    ...
    return this.isJsonObjEqual(routeArr, realRouteArr) || this.isJsonObjEqual([routeArr.join('/')], realRouteArr);
  }
